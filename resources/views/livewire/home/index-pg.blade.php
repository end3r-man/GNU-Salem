        ...
        <div class="w-full h-1/3 flex items-center gap-x-2">
            <div class="h-full max-sm:w-full sm:w-1/2 relative">
                <div class="w-full h-auto absolute top-0 left-0 z-10 bg-[#11698E]/60 backdrop-blur-sm px-3 py-2">
                    <h3 class="text-[#F8F1F1] font-semibold">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                </div>
            ...
            <div class="h-full w-1/2 relative hidden sm:block">
                ...
                <img class="absolute top-0 left-0 size-full object-cover object-center" src="https://wallpapercave.com/wp/wp14230856.jpg" alt="feature-img">
            </div>
        </div>
    </div>
</div>
